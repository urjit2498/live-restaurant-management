(function($) {
  ...
  var currentSubNavLink = $('.sidebar-subnav__link[href="' + url + '"]');
  var currentNavLink = $('.sidebar-nav__link[href="' + url + '"]');

  if (currentSubNavLink.length) {
    currentSubNavLink.addClass('is-active');
    currentSubNavLink.closest('.sidebar-nav__item').addClass('is-active');
    currentSubNavLink.closest('.sidebar-subnav').show();
  } else if (currentNavLink.length) {
    currentNavLink.closest('.sidebar-nav__item').addClass('is-active');
  }
})(jQuery);
